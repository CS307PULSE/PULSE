...
CREATE TABLE IF NOT EXISTS pulse.users(
    ...
    friends varChar(5000),                                                 -- "Friend1,Friend2,Friend3...." (String)
    high_scores varChar(200),                                            -- "Score1,Score2,Score3..." (String but individual scores can be converted to ints)
    theme INT(2) ZEROFILL NOT NULL,                              -- Chosen theme. Defaults to 0 (dark mode)
    recommendation_params varChar(200)                                   --  "Stat1,Stat2,Stat3,Stat4..." (String but individual stats can be converted to doubles)
);